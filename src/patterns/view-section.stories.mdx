...
A `ViewSection` can be used to group relevant information together. A example group of information could be **Account Information** or **Address**. You would like to use the `DataList` Component to display these groups of Information or you can use a `DataTable` Component to display informations as a list.
