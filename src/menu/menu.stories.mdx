  ...
  <Story name="menu-example">
    <div className="flex justify-center space-y-4 h-60 mx-12">
      <Menu>
            ...
            <MenuList>
                <MenuItem onClick={() => console.log('1')}>
                    MenuItem 1
                </MenuItem>
...
## Example with disabled MenuButton

<Canvas>
  <Story name="menu-example-disabled-menu-button">
    <div className="flex justify-center space-y-4 h-60 mx-12">
      <Menu>
            <MenuButton rightIcon="chevron-down" isDisabled>Show me all the options</MenuButton>
            <MenuList>
                <MenuItem>
                    <Icon icon="home" className="w-5 h-5 inline-block mr-3" />
                    Home
